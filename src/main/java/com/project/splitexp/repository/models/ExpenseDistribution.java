...
@Entity(name = "split_exp_expense_distribution")
@Table(name = "split_exp_expense_distribution")
public class ExpenseDistribution {
  ...
  @Column(name = "expense_id", columnDefinition = "uuid", nullable = false)
  private UUID expenseId;

  @Column(name = "user_id", columnDefinition = "uuid", nullable = false)
  private UUID userId;

  @Column(name = "user_contribution", columnDefinition = "numeric", nullable = false)
  private double userContribution;

  @Column(name = "contribution_type", columnDefinition = "integer", nullable = false)
